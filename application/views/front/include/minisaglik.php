...
<h3><a href='<?php echo base_url('anasayfa/saglik') ?>'>SAĞLIK HABERLERİ</a></h3></div>
<div class="clearfix"></div>
<div class="box-news box-news-1 box-news-sidebar">
<div class="row">
<ul>
<?php $skat=6; $sveriler=sonhabercek($skat);foreach ($sveriler as $veri) { ?>
...
<div class="box-news-title">
	<a href="<?php echo base_url('anasayfa/saglikdetay/'); echo $veri['sef'] ?>" title="<?php echo $veri['title']; ?>" rel="bookmark"><?php echo $veri['title'] ?></a>
</div>
...
<div class="post-more"><a href="<?php echo base_url('anasayfa/saglikdetay/'); echo $veri['sef'] ?>" title="<?php echo $veri['title']; ?>" class="button-default small"  rel="bookmark">Devamı</a></div>
</div>
<div class="clearfix"></div>
</div>
</li>
<?php } ?>
<?php $skat=6;$veriler = habercek($skat); foreach ($veriler as $veri) { ?>
<li class="col-md-6 col-sm-6 col-xs-6 col-mo-100">
